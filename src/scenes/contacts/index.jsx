...
const Contacts = () => {
  ...
  const handleDeshabilitar = (id) => {
    ...
    fetch(`https://brainly-back.onrender.com/pacientes/${id}/deshabilitar`, {
      method: "PUT",
  ...
  const handleHabilitar = (id) => {
    // Enviar una petición PUT al servidor para deshabilitar el usuario
    fetch(`https://brainly-back.onrender.com/pacientes/${id}/habilitar`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  const handleFormSubmit = (newPatientData) => {
    ...
    fetch(`https://brainly-back.onrender.com/pacientes/${currentPatient.id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
